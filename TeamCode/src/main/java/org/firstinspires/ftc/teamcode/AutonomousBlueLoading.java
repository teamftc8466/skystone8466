...
public class AutonomousBlueLoading extends AutonomousCommon {
    AutoOperation [] opBlueLoading= {
            ...
            new AutoOperation(AutoOperation.OpCode.OP_GRAB_FIRST_SKYSTONE, 2),   // This opMode is still unfinished
    ...
    double [][] blueGrabFirstSkystone_ = {{ -0.34, 0.735, 1.96},           // TODO: Determine actual measurements
                                          { -0.14, 0.73, 2.16},
                                          { 0.04, 0.73, 2.34}};
