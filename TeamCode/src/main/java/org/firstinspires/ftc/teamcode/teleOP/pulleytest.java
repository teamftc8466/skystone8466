...
public class pulleytest extends OpMode {
    ...
    public double motorpower1 = 0;//same with motorpower
        ...
        public void init() {
            ...
            pulleymotor1.setDirection(DcMotor.Direction.FORWARD);
        ...
        public void loop() {
            ...
            /*if(gamepad1.right_stick_y < .1 && gamepad1.right_stick_y > -.1) {
                ...
                if(functtime.time() <= 10000) {
                    motorpower1 = Math.pow((1/10000)*functtime.time()*(1 / gamepad1.right_stick_y), 3);
                ...
                if(this.getRuntime() <= 10000) {
                    //deltafunctime = this.getRuntime()-functime;
                    motorpower1 = Math.pow((1/10000)*this.getRuntime()*(1/gamepad1.right_stick_y), 3);
                    pulleymotor1.setPower(motorpower1);
                    //pulleymotor1.setPower(motorpower1);
                    System.out.println(this.getRuntime());
                }
