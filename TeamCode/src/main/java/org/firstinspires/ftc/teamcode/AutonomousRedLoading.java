...
public class AutonomousRedLoading extends AutonomousCommon {
    AutoOperation [] opRedLoading_ = {
            ...
            new AutoOperation(AutoOperation.OpCode.OP_DRIVE_TRAIN_TURN_RIGHT, 120),   // Overestimating is for compensating for the extra drag the foundation creates, TODO: Program IMU?
