...
public class MichaelTensorFlow extends LinearOpMode {
...
//   private static final String VUFORIA_KEY = "";
    //  private RobotState myRobotState = RobotState.TEST;
...
//         initTfod();
    ...
    private void targetSkystone() {
        ...
        //          int detectionWidth = skystoneBlockRightX - skystoneBlockLeftX;

        //          if (detectionWidth < 500) { //change value later
